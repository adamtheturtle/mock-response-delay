...
htmlhelp_basename = "MOCKRESPONSEDELAYdoc"
...
nitpicky = True
# ``httpx`` and ``httpx2`` document their APIs without Sphinx, so there
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/adamtheturtle/mock-response-delay/",
    "source_branch": "main",
...
.. |github-repository| replace:: mock-response-delay
"""
